const url = 'https://boolean-api-server.fly.dev/Shaun-Harris/pokemon'
...
async function deletePokemon(pokemon) {
    const deleteUrl = `https://boolean-api-server.fly.dev/Shaun-Harris/pokemon/${pokemon.id}`
    const options = {
        method: 'DELETE',
        headers: {
            'Content-type': 'application/json',
...
async function updatePokemon(pokemon, newNameInput, newImageInput) {
    const updateUrl = `https://boolean-api-server.fly.dev/Shaun-Harris/pokemon/${pokemon.id}`
    const options = {
        method: 'PUT',
        body: JSON.stringify({
            name: newNameInput,
...
async function likePokemon(pokemon) {
    const likeUrl = `https://boolean-api-server.fly.dev/Shaun-Harris/pokemon/${pokemon.id}`
    const options = {
        method: 'PUT',
        body: JSON.stringify({
            name: pokemon.name,
